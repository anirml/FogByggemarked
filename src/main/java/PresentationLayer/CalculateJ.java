...
public class CalculateJ extends Command {
    ...
    String execute(HttpServletRequest request, HttpServletResponse response) throws FogException {
        ...
        int[] arrayRafter = LogicFacade.rafter(cl, cW);

        int[] arrayStern = LogicFacade.stern(cl, cW);

        int[] arrayRoof = LogicFacade.roofFlat(cl, cW);
        ...
        if ((shedLen != 0)&& (shedWid != 0)) shed = true;
        ...
        postArray=stolpXY(cl,cW,shedLen,shedWid);

        //Beregning af remdeling
        int remShareX = 0;
        if (cl >= 6901 && cl <= 9000) {
            int min = cl;
            int diff = 0;
        ...
        stykList(request, cl,cW,shedLen,shedWid);
...
//******GENERING AF TEGNING **** SLUT ***********************************************************************
    ...
    public static void stykList (HttpServletRequest request, int cl, int cW, int shedLen, int shedWid) throws FogException {
